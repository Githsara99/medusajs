...
var ProfileEmail = function (_a) {
    ...
    var _c = (0, react_dom_1.useFormState)(actions_1.updateCustomerPhone, {
        error: false,
        success: false,
    ...
    return (<form action={formAction} className="w-full">
      <account_info_1.default label="Phone" currentInfo={"".concat(customer.phone)} isSuccess={successState} isError={!!state.error} errorMessage={state.error} clearState={clearState}>
        <div className="grid grid-cols-1 gap-y-2">
          <input_1.default label="Phone" name="phone" type="phone" autoComplete="phone" required defaultValue={customer.phone}/>
        </div>
