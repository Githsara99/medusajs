...
function search(query) {
    return __awaiter(this, void 0, void 0, function () {
        var queries, results, hits;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    queries = [{ params: { query: query }, indexName: search_client_1.SEARCH_INDEX_NAME }];
                    return [4 /*yield*/, search_client_1.searchClient.search(queries)];
                case 1:
