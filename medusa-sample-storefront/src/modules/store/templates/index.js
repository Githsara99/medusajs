...
var paginated_products_1 = require("./paginated-products");
var StoreTemplate = function (_a) {
    var sortBy = _a.sortBy, page = _a.page, countryCode = _a.countryCode;
    ...
    return (<div className="flex flex-col small:flex-row small:items-start py-6 content-container">
      ...
      <div className="w-full">
        ...
        <react_1.Suspense fallback={<skeleton_product_grid_1.default />}>
          <paginated_products_1.default sortBy={sortBy || "created_at"} page={pageNumber} countryCode={countryCode}/>
        </react_1.Suspense>
      </div>
    </div>);
};
